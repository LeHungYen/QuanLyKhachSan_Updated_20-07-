...
public class NhanVienModel {
	...
	public NhanVienModel(String maNV, String tenNV, String sdt, String gioiTinh, String email, ChucVuModel chucVuModel,
			String trangThai, String cmnd, String userName, String password,
	...
	public String toString() {
		return "NhanVienModel [maNV=" + maNV + ", tenNV=" + tenNV + ", sdt=" + sdt + ", gioiTinh=" + gioiTinh
				...
				+ ", userName=" + userName + ", password=" + password + ", listPhieuNhapKhoModel="
				+ listPhieuNhapKhoModel + ", listPhieuKiemKhoModel=" + listPhieuKiemKhoModel + ", listHoaDonModel="
				+ listHoaDonModel + "]";
	}
