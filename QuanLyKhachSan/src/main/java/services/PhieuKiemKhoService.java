...
public class PhieuKiemKhoService {
	...
	public static PhieuKiemKho updateDataPhieuKiemKhoDependOnPhieuKiemKhoModel(PhieuKiemKhoModel PhieuKiemKhoModel) {
		...
		PhieuKiemKho.setNhanVien(PhieuKiemKhoModel.getNhanVienModel());
		PhieuKiemKho.setKho(PhieuKiemKhoModel.getKhoModel());
		PhieuKiemKho.setListPhieuKiemKhoChiTiet(PhieuKiemKhoModel.getListPhieuKiemKhoChiTietModel());
		return PhieuKiemKho;
	}
	public static PhieuKiemKhoModel updateDataPhieuKiemKhoModelDependOnPhieuKiemKho(PhieuKiemKho PhieuKiemKho) {
		...
		PhieuKiemKhoModel.setNhanVienModel(PhieuKiemKho.getNhanVien());
		PhieuKiemKhoModel.setKhoModel(PhieuKiemKho.getKho());
		PhieuKiemKhoModel.setListPhieuKiemKhoChiTietModel(PhieuKiemKho.getListPhieuKiemKhoChiTiet());
		return PhieuKiemKhoModel;
	}
	
	public List<PhieuKiemKhoModel> updateListKiemKhoModelDependOnListPhieuKiemKho (List<PhieuKiemKho> listPhieuKiemKho){
	...
	public List<PhieuKiemKho> updateListKiemKhoDependOnListPhieuKiemKhoModel (List<PhieuKiemKhoModel> listPhieuKiemKhoModel){
	...
	public void updateListPhieuKiemKhoModel() {
		...
		_listPhieuKiemKhoModels = updateListKiemKhoModelDependOnListPhieuKiemKho(listPhieuKiemKho);
	}
