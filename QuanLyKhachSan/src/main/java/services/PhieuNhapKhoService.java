...
public class PhieuNhapKhoService {
	...
	public static PhieuNhapKho updateDataPhieuNhapKhoDependOnPhieuNhapKhoModel(PhieuNhapKhoModel PhieuNhapKhoModel) {
		...
		PhieuNhapKho.setNhanVien(PhieuNhapKhoModel.getNhanVienModel());
		...
		PhieuNhapKho.setListPhieuNhapKhoChiTiet(PhieuNhapKhoModel.getListPhieuNhapKhoChiTietModel());
		return PhieuNhapKho;
	}
	public static PhieuNhapKhoModel updateDataPhieuNhapKhoModelDependOnPhieuNhapKho(PhieuNhapKho PhieuNhapKho) {
		...
		PhieuNhapKhoModel.setNhanVienModel(PhieuNhapKho.getNhanVien());
		...
		PhieuNhapKhoModel.setListPhieuNhapKhoChiTietModel(PhieuNhapKho.getListPhieuNhapKhoChiTiet());
		return PhieuNhapKhoModel;
	}

	public List<PhieuNhapKhoModel> updateListPhieuNhapKhoModelDependOnListPhieuNhapKho (List<PhieuNhapKho> listPhieuNhapKho){
	...
	public List<PhieuNhapKho> updateListPhieuNhapKhoDependOnListPhieuNhapKhoModel (List<PhieuNhapKhoModel> listPhieuNhapKhoModel){
