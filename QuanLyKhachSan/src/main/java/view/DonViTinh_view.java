...
//	private int _sttNhanVienEditing;
	...
	public void updateTable() {
		...
		for (DonViTinhModel donViTinhModel : _listDonViTinhModels) {
			...
			if(switchButton_danhSach.isSelected() && donViTinhModel.getTrangThai().equals("Hoạt Động")) {
				model.addColumn(new Object[] {donViTinhModel.getStt(),donViTinhModel.getMaDonVi(),donViTinhModel.getTenDonVi(),donViTinhModel.getTrangThai()});
			}else if(!switchButton_danhSach.isSelected() && donViTinhModel.getTrangThai().equals("Không Hoạt Động")) {
				model.addColumn(new Object[] {donViTinhModel.getStt(),donViTinhModel.getMaDonVi(),donViTinhModel.getTenDonVi(),donViTinhModel.getTrangThai()});
			}
		}
	...
	public DonViTinhModel getInforFromFormIntoDonViTinhModel() {
		...
		DonViTinhModel donViTinhModel = new DonViTinhModel(0, maDonVi, tenDonVi, trangThai, null, null);
